[FallGuard-CV 基于计算机视觉的实时人体姿态识别与跌倒监护系统.md](https://github.com/user-attachments/files/30263418/FallGuard-CV.md)
- 
...
- `T` 键：测试微信推送并切换至 PyQt5 交互大屏(视频训练模块，用户可以自己上传视频到项目目录里面，然后进行训练，以完成对模型更加精确准确的调整)
- `Q` 键：安全退出系统
